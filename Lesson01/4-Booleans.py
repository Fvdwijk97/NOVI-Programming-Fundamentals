...
print(f"x: {x > 0 and x < 10}")
print(f"y: {y > 0 and Y < 10}")
...
getal_1 = float(input("Voer eerste getal in: "))
getal_2 = float(input("Vul tweede getal in: "))

print(f"{getal_1} + {getal_2} is: {getal_1 + getal_2}!")
