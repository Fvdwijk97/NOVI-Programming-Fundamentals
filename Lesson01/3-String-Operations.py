...
variabele_een = '5' # string
variabele_twee = 1 / 1 # float
variabele_drie = 'Python' * 3 # string
...
# a. And = ‘something’ mag wel want hoofdletter
# b. while = ‘something’ mag niet
# c. Break = ‘something’ mag wel want hoofdletter
# d. none = ‘something’ mag wel want kleine letter
# ==========================================
...
# print(int('1490.99')) # foutmelding, want aanhalingstekens

# print(float(12)) # geen foutmelding

# print(int('1plus1')) # foutmelding

# print(str(25E10)) # geen foutmelding
